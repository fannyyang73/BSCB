...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/BSCB)](https://CRAN.R-project.org/package=BSCB)
<!-- badges: end -->
...
- Yang, F., Han, Y., Liu, W., & Hall, I. (2026). 
  [Bayesian simultaneous credible bands for polynomial regression](https://arxiv.org/abs/2606.28015).
  arXiv preprint arXiv:2606.28015. 
