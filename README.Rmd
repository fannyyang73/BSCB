...
Bands (BSCB) for polynomial regression models. The package implements three 
approaches based on different prior specifications:

- **BSCB-C**: Normal-Gamma conjugate prior (empirical Bayes, unit-information, or g-prior)
- **BSCB-J**: Independent Jeffreys prior
- **BSCB-H**: Non-conjugate prior via Hamiltonian Monte Carlo

A full demo is available [here](https://github.com/fannyyang73/BSCB/tree/main/demo/BSCB_demo.Rmd).
