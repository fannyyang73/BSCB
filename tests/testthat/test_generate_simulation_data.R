...
test_that("invalid inputs are rejected", {
  expect_error(
    generate_simulation_data(p = 4, n = 20, e_sd = 0.2,
                             theta_true = c(1, 2, 3, 4, 5), replication = 5),
    "p must be 1, 2, or 3"
  )
  expect_error(
    generate_simulation_data(p = 2, n = 20, e_sd = 0.2,
                             theta_true = c(1, 2), replication = 5),
