...
- **BSCB-H**: BSCB under the non-conjugate prior implemented via HMC
...
ggplot() +
  ...
  values = band_colours,
  name   = "Method",
  breaks = c("BSCB-C-G", "BSCB-H-C", "BSCB-I-J", "BPCB-I-J")) +
  scale_fill_manual(
  values = band_colours,
  name   = "Method",
  breaks = c("BSCB-C-G", "BSCB-H-C", "BSCB-I-J", "BPCB-I-J")) +
  ...
  breaks = c("BSCB-C-G", "BSCB-H-C", "BSCB-I-J", "BPCB-I-J")) +
  labs(
    title = "95% BSCB-C-G, BSCB-H-C, BSCB-I-J and BPCB-I-J for Quadratic Regression",
    x     = "x",
    y     = "y"
  ) +
  theme_bw() +
...
pscp_c <- coverage_PSCP(fit_c, draw_num = 10000,
                         optimize_type = "P", verbose = TRUE)
pscp_h <- coverage_PSCP(fit_h, draw_num = 10000,
                         optimize_type = "P", verbose = TRUE)
...
cat("PSCP (BSCB-H-C):", round(pscp_h, 4), "\n")
...
summary_tab <- data.frame(
  Method   = c("BSCB-C-G","BSCB-H-C", "BSCB-I-J"),
  Lambda   = round(c(fit_c$lambda,fit_h$lambda, fit_j$lambda), 4),
  ESCR     = c(escr_c,escr_h, escr_j),
  PSCP     = round(c(pscp_c,pscp_h, pscp_j), 4)
)
