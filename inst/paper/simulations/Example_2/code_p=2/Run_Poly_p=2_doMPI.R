...
rho <- 0.2
AR_index <- 1 # 0: iid error; 1: auto-regressive error
...
########################       Parallel Computing       ########################
multiResultClass <- function(i=NULL, lambda_best_optim=NULL, coverage_flag=NULL, mu_star=NULL, cov_theta=NULL, coverage_prob=NULL, coverage_draw=NULL, seed_used=NULL, elapsed_time=NULL){
  me <- list(i = i, lambda_best_optim = lambda_best_optim, coverage_flag = coverage_flag, mu_star = mu_star,
             cov_theta=cov_theta, coverage_prob = coverage_prob, coverage_draw = coverage_draw, seed_used = seed_used, elapsed_time = elapsed_time)
...
model_path <- "/mnt/iusers01/maths01/w85950fy/SCB/10000/HMC_p=2.stan"
if(HMC_setting == 1){
  Sys.setenv(CMDSTAN = "/mnt/iusers01/maths01/w85950fy/.cmdstan/cmdstan-2.37.0")
